            ...
            <div className="mx-auto flex w-full max-w-7xl flex-1 flex-col gap-6 p-4 md:p-8">
                <Card className="border-zinc-200 shadow-sm dark:border-zinc-800">
                    <CardHeader>
                        ...
                        <CardDescription>
                            All payment transactions recorded across the
                            platform.
                        </CardDescription>
                    </CardHeader>
                    <CardContent>
                                        ...
                                        payments.data.map((payment) => (
                                            <TableRow key={payment.id}>
                                                ...
                                                <TableCell>
                                                    ...
                                                    payment.status ===
                                                        'paid' ? (
                                                        <span className="inline-flex items-center gap-1.5 rounded-md bg-emerald-100 px-2 py-1 text-xs font-medium text-emerald-800 dark:bg-emerald-900 dark:text-emerald-200">
                                                            <Activity className="h-3 w-3" />{' '}
                                                            Paid
                                                        </span>
                                                    ) : (
                                                        <span className="inline-flex items-center gap-1.5 rounded-md bg-amber-100 px-2 py-1 text-xs font-medium text-amber-800 dark:bg-amber-900 dark:text-amber-200">
                                                            {payment.status}
                                                        </span>
                                                    )}
                                                </TableCell>
                        ...
                        {payments.last_page > 1 && (
                            <div className="mt-6 flex items-center justify-between">
                                <span className="text-sm text-zinc-500">
                                    Showing page {payments.current_page} of{' '}
                                    {payments.last_page} ({payments.total} total
                                    transactions)
                                </span>
